...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    # Add the product into the total molar mass.
            total_molas_mass += product
    # Return the total molar mass.
    return total_molas_mass
...
def main():
    ...
    symbols_quantity = parse_formula(chemical_formula, periodic_table)

    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    total_molar_mass = compute_molar_mass(symbols_quantity, periodic_table)

    # Compute the number of moles in the sample.
    moles_number = round(chemical_sample / total_molar_mass, 5)

    # Print the molar mass.
    print(f'{total_molar_mass} grams/mole')
    # Print the number of moles.
    print(f'{moles_number} moles')
